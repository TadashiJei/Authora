          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                ...
                <br />
                <span className="text-gray-900">Verified Identity.</span>
                <br />
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-2xl">
                Instantly onboard to Web3. Accept crypto payments with zero friction. No browser extensions, no seed
                phrases, no crypto knowledge required.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Shield,
                title: "Civic Auth Security",
                description: "Bank-level security with privacy-first authentication",
                gradient: "from-blue-500 to-purple-600",
              },
              {
                icon: Zap,
                title: "Instant Wallet",
                description: "Non-custodial wallet created in seconds, no setup required",
                gradient: "from-purple-500 to-pink-600",
              },
              {
                icon: ArrowRight,
                title: "Payment Links",
                description: "Share your personalized page and receive crypto payments",
